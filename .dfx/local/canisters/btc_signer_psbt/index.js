...
import { idlFactory } from './btc_signer_psbt.did.js';
export { idlFactory } from './btc_signer_psbt.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BTC_SIGNER_PSBT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./btc_signer_psbt.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the btc_signer_psbt canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./btc_signer_psbt.did.js")._SERVICE>}
 */
export const btc_signer_psbt = createActor(canisterId);
