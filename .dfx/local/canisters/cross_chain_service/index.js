...
import { idlFactory } from './cross_chain_service.did.js';
export { idlFactory } from './cross_chain_service.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CROSS_CHAIN_SERVICE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cross_chain_service.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cross_chain_service canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cross_chain_service.did.js")._SERVICE>}
 */
export const cross_chain_service = createActor(canisterId);
