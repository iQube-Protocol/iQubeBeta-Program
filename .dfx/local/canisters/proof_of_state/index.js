...
import { idlFactory } from './proof_of_state.did.js';
export { idlFactory } from './proof_of_state.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PROOF_OF_STATE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./proof_of_state.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the proof_of_state canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./proof_of_state.did.js")._SERVICE>}
 */
export const proof_of_state = createActor(canisterId);
